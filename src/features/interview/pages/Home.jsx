            ...
            <div className='interview-card'>
                <div className='interview-card__body'>
                    ...
                    <div className='panel panel--left'>
                        ...
                        <textarea
                            ...
                            maxLength={5000}
                        />
                        <div className='char-counter'>{jobDescriptionLength} / 5000 chars</div>
                    ...
                    <div className='panel panel--right'>
                        ...
                        <div className='upload-section'>
                            ...
                            <label 
                                className={`dropzone ${isDragging ? 'dragging' : ''} ${resumeFile ? 'success' : ''} ${fileError ? 'error' : ''}`}
                                htmlFor='resume'
                            ...
                            >
                                ...
                                {resumeFile ? (
                                    <>
                                        ...
                                        <p className='dropzone__subtitle dropzone__subtitle--success'>{Math.round(resumeFile.size / 1024)} KB</p>
                                    </>
                                ) : fileError ? (
                                    <>
                                        <p className='dropzone__title dropzone__title--error'>❌ Error</p>
                                        <p className='dropzone__subtitle dropzone__subtitle--error'>{fileError}</p>
                                    </>
                                ) : (
                                    <>
                ...
                <div className='interview-card__footer'>
                    ...
                    <button
                        ...
                        className={`generate-btn ${!isValid ? 'generate-btn--disabled' : ''}`}>
